...
module.exports.dashboard = function(req,res){
	...
	if(sess.emailid && sess.type == req.params.userType){
		...
		//if user is client
			...
			res.render('dashboardc',{title:'Dashboard',linkHome:'/',nameHome:'LawyerHub',userName:sess.emailid,apName:'My Posts',makePostButtonLink:'/dashboard/createPost',makePostButtonName:'Create Post'});
		}
	}
